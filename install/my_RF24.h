...
// TODO: My functions
    ...
    //bool begin(int SPI_idx);

    bool myBegin(char* device, int n){
       ...
       //_SPI.begin(csn_pin, spi_speed);
        _SPI.myBegin(csn_pin, spi_speed);
    ...
    void setWritingPipe(uint64_t value);
    void setWritingPipe(const uint8_t* address);
