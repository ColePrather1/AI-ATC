...
// Locations
    ...
    std::atomic<double> atc_gps_lat, atc_gps_lon;   // TODO: in Packets & SQL, fix Lat/Lon types from int32_t to double
    double calc_atc_gps_lat, calc_atc_gps_lon;
    std::atomic<uint16_t> plane_gps_alt;
    std::atomic<double> plane_gps_lat, plane_gps_lon;    // TODO: in Packets & SQL, fix Lat/Lon types from int32_t to double
